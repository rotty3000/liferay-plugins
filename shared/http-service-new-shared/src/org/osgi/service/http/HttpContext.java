 ...
 *
 * <p>
 * Servlets may be {@link HttpConstants#HTTP_WHITEBOARD_CONTEXT_NAME associated}
 * with an {@code HttpContext} service. Servlets that are associated using the
 * same {@code HttpContext} object will share the same {@code ServletContext}
 * object.
 *
 * <p>
 ...
 *
 * @ThreadSafe
 * @author $Id: d45c7f4911157e60ab6712462735da25380eb262 $
...
public interface HttpContext {
	 ...
	 * {@code getResourceAsStream}. For {@link ResourceServlet} servlets, Http
	 ...
	 * {@code ServletContext} method {@code getMimeType}. For
	 * {@link ResourceServlet} servlets, the Http Service will call this method
	 * to determine the MIME type for the {@code Content-Type} header in the
	 * response.
	 *
