...
@Component(
	immediate = true,
	property = {
		"javax.portlet.name=TP_9",
		"javax.portlet.preferences=classpath:/com/liferay/test/portlet/prefs.xml"
	},
	service = Portlet.class
)
public class TestPortlet_9 extends BaseTestPortlet {
	...
	public void render(RenderRequest request, RenderResponse response)
		...
		writer.println("<br/>");
		writer.print("Preferences (from classpath): ");
