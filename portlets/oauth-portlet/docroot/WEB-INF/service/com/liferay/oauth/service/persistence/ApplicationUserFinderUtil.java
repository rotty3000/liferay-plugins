...
public class ApplicationUserFinderUtil {
	...
	public static java.util.List<com.liferay.oauth.model.ApplicationUser> findByO(
	...
	public static ApplicationUserFinder getFinder() {
		if (_finder == null) {
			_finder = (ApplicationUserFinder)PortletBeanLocatorUtil.locate(com.liferay.oauth.service.ClpSerializer.getServletContextName(),
